...
```{r team_csvs}
write.csv(offense_season, "data/team_offense_season.csv", row.names = FALSE)
write.csv(offense_weekly, "data/team_offense_weekly.csv", row.names = FALSE)
write.csv(defense_season, "data/team_defense_season.csv", row.names = FALSE)
write.csv(defense_weekly, "data/team_defense_season.csv", row.names = FALSE)
```
